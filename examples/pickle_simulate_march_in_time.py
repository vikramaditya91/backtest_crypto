...
def main():
    ...
    store_largest_xarray(sqlite_access_creator,
                         ...
                         file_path=str(pathlib.Path(pathlib.Path(__file__).parents[3] /
                                                    "common_db" /
    ...
    pickled_potential_path = str(pathlib.Path(pathlib.Path(__file__).parents[3] /
                                              "common_db" /
    ...
    with open(pathlib.Path(pathlib.Path(__file__).parents[3] /
                           "common_db" /
